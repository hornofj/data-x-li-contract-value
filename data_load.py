...
df_final005 = df_generate_sample(0.005, '../data-x-li-data/scen_sample_005p.csv')
...
df_merged005, target01 = df_merge_nss(df_final005, '../data-x-li-data/scen_sample_005p_nss.csv')
...
df_split_to_pickle(df_merged005, target01, '005p')
